...
export default function TitleInput({placeholder, onSubmit, required = false, value}: {
    placeholder: string,
    ...
    function onSubmitWrap(e: FormEvent<HTMLFormElement>) {
        ...
        return <form className="flex justify-center" onSubmit={onSubmitWrap} noValidate spellCheck={false}>
            <input
                ...
                type={"text"} placeholder={placeholder} maxLength={24} required={required} defaultValue={value}/>
        </form>
}